...
#         bash cleanse.sh
	...
	-n 4 -x -P  -e  125896  -i 0.01 1 0.4 0.5 11 .2 \
...
# 	-o output_p25gy.out \
# 	-z ~/Desktop/research/histogram_20kEMD_v150_compare.hist \
# 	-n 4 -x -P  -e  125896 -i 0.25 1 0.4 0.5 11 .2 \
# 	2>>~/Desktop/research/piped_output.txt
...
# 	-o output_p5gy.out \
# 	-z ~/Desktop/research/histogram_20kEMD_v150_compare.hist \
# 	-n 4 -x -P  -e  125896 -i 0.5 1 0.4 0.5 11 .2 \
# 	2>>~/Desktop/research/piped_output.txt
...
# 	-o output_p75gy.out \
# 	-z ~/Desktop/research/histogram_20kEMD_v150_compare.hist \
# 	-n 4 -x -P  -e  125896 -i 0.75 1 0.4 0.5 11 .2 \
# 	2>>~/Desktop/research/piped_output.txt
...
# 	-o output_1gy.out \
# 	-z ~/Desktop/research/histogram_20kEMD_v150_compare.hist \
# 	-n 4 -x -P  -e  125896 -i 1 1 0.4 0.5 11 .2 \
# 	2>>~/Desktop/research/piped_output.txt
...
# 	-o output_2gy.out \
# 	-z ~/Desktop/research/histogram_20kEMD_v150_compare.hist \
# 	-n 4 -x -P  -e  125896 -i 2 1 0.4 0.5 11 .2 \
# 	2>>~/Desktop/research/piped_output.txt
...
# 	-o output_3gy.out \
# 	-z ~/Desktop/research/histogram_20kEMD_v150_compare.hist \
# 	-n 4 -x -P  -e  125896 -i 3 1 0.4 0.5 11 .2 \
# 	2>>~/Desktop/research/piped_output.txt
...
# 
	...
	-o output_4gy.out \
	-z ~/Desktop/research/histogram_20kEMD_v150_compare.hist \
	-n 4 -x -P -e  125896   -i 4 1 0.4 0.5 11 .2 \
# 	2>>~/Desktop/research/piped_output.txt
