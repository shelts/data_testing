...
plot "binned_data/pot_0gy.dat" using 2:1  with boxes title 'actual', "theory/theory_pot_calc.dat"   using 1:3 with lines title 'light',  "theory/theory_pot_calc.dat"   using 2:4 with lines title 'dark'
