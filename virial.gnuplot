...
set terminal jpeg
set key off
set output "plots/energy/virial.jpeg"
set title 'Virial Ratio over time'
set ylabel 'Virial Ratio'
set xlabel 'Simulation Time (Gyr)'
# set xrange[0:4]
# set yrange[0:3]
plot "./test_output/virial_output.txt" using 6:4  with points


# reset
# set terminal jpeg
# set key off
# set output "plots/rho.jpeg"
# set title 'Rho vs r'
# set ylabel 'Rho'
# set xlabel 'r (Mpc)'
# set xrange[0:16]
# set yrange[0:.3]
# plot "./test_output/rho_test.txt" using 2:1 with dots
...
# set xrange[0:25]
# set yrange[0:8]
# plot "./test_output/vel_dis_0gy.txt" using 2:1 with dots
# 
# reset
# set terminal jpeg
# set key off
...
# set xrange[0:25]
# set yrange[0:8]
# plot "./test_output/vel_dis_p25gy.txt" using 2:1 with dots
# 
# reset
# set terminal jpeg
# set key off
...
# set xrange[0:25]
# set yrange[0:8]
# plot "./test_output/vel_dis_p5gy.txt" using 2:1 with dots
# 
# reset
# set terminal jpeg
# set key off
...
# set xrange[0:25]
# set yrange[0:8]
# plot "./test_output/vel_dis_p75gy.txt" using 2:1 with dots
# 
# 
# 
# reset
...
# set xrange[0:25]
# set yrange[0:8]
# plot "./test_output/vel_dis_1gy.txt" using 2:1 with dots
# 
# reset
# set terminal jpeg
# set key off
...
# set xrange[0:25]
# set yrange[0:8]
# plot "./test_output/vel_dis_2gy.txt" using 2:1 with dots
# 
# reset
# set terminal jpeg
# set key off
...
# set xrange[0:25]
# set yrange[0:8]
# plot "./test_output/vel_dis_3gy.txt" using 2:1 with dots
# 
# reset
# set terminal jpeg
# set key off
...
# set xrange[0:25]
# set yrange[0:8]
# plot "./test_output/vel_dis_4gy.txt" using 2:1 with dots