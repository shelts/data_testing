...
plot actual_light."0gy.dat" using 2:1  with boxes title 'actual',  light   using 2:1 with lines  title 'light dist'  lw 2  ,  light_nemo   using 2:1 with boxes title 'light nemo'  lw 2 
...
plot actual_dark."0gy.dat" using 2:1  with boxes title 'actual',  dark   using 2:1 with lines title 'dark dist' lw 2 , dark_nemo   using 2:1 with boxes title 'dark nemo' lw 2 
...
plot actual_light."p25gy.dat" using 2:1  with boxes title 'actual',  light   using 2:1 with lines title 'light dist'  lw 2,  light_nemo   using 2:1 with boxes title 'light nemo'  lw 2
...
plot actual_dark."p25gy.dat" using 2:1  with boxes title 'actual', dark   using 2:1 with lines title 'dark dist' lw 2, dark_nemo   using 2:1 with boxes title 'dark nemo' lw 2  
...
plot actual_light."p5gy.dat" using 2:1  with boxes title 'actual',  light   using 2:1 with lines title 'light dist'  lw 2,  light_nemo   using 2:1 with boxes title 'light nemo'  lw 2
...
plot actual_dark."p5gy.dat" using 2:1  with boxes title 'actual',    dark   using 2:1 with lines title 'dark dist' lw 2, dark_nemo   using 2:1 with boxes title 'dark nemo' lw 2  
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # 
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
...
plot actual_light."p75gy.dat" using 2:1  with boxes title 'actual',   light   using 2:1 with lines title 'light dist'  lw 2,  light_nemo   using 2:1 with boxes title 'light nemo'  lw 2,
...
plot actual_dark."p75gy.dat" using 2:1  with boxes title 'actual',   dark   using 2:1 with lines title 'dark dist' lw 2, dark_nemo   using 2:1 with boxes title 'dark nemo' lw 2  
...
plot actual_light."1gy.dat" using 2:1  with boxes title 'actual',  light   using 2:1 with lines title 'light dist'  lw 2,  light_nemo   using 2:1 with boxes title 'light nemo'  lw 2, 
...
plot actual_dark."1gy.dat" using 2:1  with boxes title 'actual',   dark   using 2:1 with lines title 'dark dist' lw 2, dark_nemo   using 2:1 with boxes title 'dark nemo' lw 2  
...
plot actual_light."2gy.dat" using 2:1  with boxes title 'actual',  light   using 2:1 with lines title 'light dist'  lw 2,  light_nemo   using 2:1 with boxes title 'light nemo'  lw 2,  
...
plot actual_dark."2gy.dat" using 2:1  with boxes title 'actual',   dark   using 2:1 with lines title 'dark dist' lw 2, dark_nemo   using 2:1 with boxes title 'dark nemo' lw 2  
...
plot actual_light."3gy.dat" using 2:1  with boxes title 'actual',  light   using 2:1 with lines title 'light dist'  lw 2,  light_nemo   using 2:1 with boxes title 'light nemo'  lw 2
...
plot actual_dark."3gy.dat" using 2:1  with boxes title 'actual',   dark   using 2:1 with lines title 'dark dist' lw 2, dark_nemo   using 2:1 with boxes title 'dark nemo' lw 2  
...
plot actual_light."4gy.dat" using 2:1  with boxes title 'actual',   light   using 2:1 with lines title 'light dist'  lw 2,  light_nemo   using 2:1 with boxes title 'light nemo'  lw 2
...
plot actual_dark."4gy.dat" using 2:1  with boxes title 'actual', dark   using 2:1 with lines title 'dark dist' lw 2, dark_nemo   using 2:1 with boxes title 'dark nemo' lw 2  
